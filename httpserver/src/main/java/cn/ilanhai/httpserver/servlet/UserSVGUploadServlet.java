 ...
 *
 */
public class UserSVGUploadServlet extends HttpServlet {
	...
	private Logger logger = Logger.getLogger(UserSVGUploadServlet.class);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String imgFile = (String) configuration.getSettings().get("svgFile");
		String inputName = (String) configuration.getSettings().get("svginputName");
		...
		try {
			...
			while (iterator.hasNext()) {
				...
				if (fileItem.isFormField()) {
					...
					if (!Str.isNullOrEmpty(fileItem.getString()) && "materialtypeId".equals(fileItem.getFieldName())) {
						materialtypeId = fileItem.getString();
					}
			...
			while (iterator.hasNext()) {
				...
				if (!fileItem.isFormField()) {
					if (inputName.equals(fileItem.getFieldName())) {
						...
						ResourceEntry entry = resource.save(nowSavePath, fileItem.getName(), fileItem.getInputStream());
