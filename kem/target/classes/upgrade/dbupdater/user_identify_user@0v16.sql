...
--			where table_name = tn  and column_name = 'user_id' and TABLE_SCHEMA = tn and data_type = 'varchar' AND TABLE_SCHEMA=ts) THEN 
  			alter table user_identify_user modify  column user_id varchar(255);
--		END IF;
	-- 添加列
