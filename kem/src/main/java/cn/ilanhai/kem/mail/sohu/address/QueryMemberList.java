...
import cn.ilanhai.kem.mail.protocol.sohu.address.QueryMemberListResponse;
import cn.ilanhai.kem.mail.sohu.SohuMailConfig;
import cn.ilanhai.kem.util.HttpHelper;

public class QueryMemberList {
	public QueryMemberList() {

	}

	public QueryMemberListResponse query(SohuMailConfig cfg,
			QueryMemberListRequest req) throws AppException {
		String doc = null;
		Map<String, String> params = null;
		QueryMemberListResponse resp = null;
		if (cfg == null)
		...
		resp = Result.jsonToObject(doc, QueryMemberListResponse.class);
		if (resp == null)
	 ...
	 * 日志
	 */
	private final Logger LOGGER = Logger.getLogger(QueryMemberList.class);
	/**
	 * 请求的url
	 */
	private final String URL = "http://api.sendcloud.net/apiv2/addressmember/list";
}
