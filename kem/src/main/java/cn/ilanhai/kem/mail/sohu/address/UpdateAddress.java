...
import cn.ilanhai.kem.mail.protocol.sohu.address.UpdateAddressResponse;
...
public class UpdateAddress {
	...
	public UpdateAddressResponse update(SohuMailConfig cfg,
			UpdateAddressRequest req) throws AppException {
		String doc = null;
		Map<String, String> params = null;
		UpdateAddressResponse resp = null;
		if (cfg == null)
		...
		resp = Result.jsonToObject(doc, UpdateAddressResponse.class);
		if (resp == null)
	 ...
	 * 日志
	 */
	private final Logger LOGGER = Logger.getLogger(UpdateAddress.class);
	/**
	 * 请求的url
	 */
	private final String URL = "http://api.sendcloud.net/apiv2/addresslist/update";
}
