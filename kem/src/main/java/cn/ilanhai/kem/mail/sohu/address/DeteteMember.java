...
import cn.ilanhai.kem.mail.protocol.sohu.address.DeleteMemberResponse;
import cn.ilanhai.kem.mail.sohu.SohuMailConfig;
import cn.ilanhai.kem.util.HttpHelper;

public class DeteteMember {
	public DeteteMember() {

	}

	public DeleteMemberResponse detete(SohuMailConfig cfg,
			DeleteMemberRequest req) throws AppException {
		String doc = null;
		Map<String, String> params = null;
		DeleteMemberResponse resp = null;
		if (cfg == null)
		...
		resp = Result.jsonToObject(doc, DeleteMemberResponse.class);
		if (resp == null)
	 ...
	 * 日志
	 */
	private final Logger LOGGER = Logger.getLogger(DeteteMember.class);
	/**
	 * 请求的url
	 */
	private final String URL = "http://api.sendcloud.net/apiv2/addressmember/delete";
