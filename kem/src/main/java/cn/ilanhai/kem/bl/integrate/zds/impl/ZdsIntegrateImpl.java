package cn.ilanhai.kem.bl.integrate.zds.impl;
...
import cn.ilanhai.kem.bl.integrate.zds.ZdsIntegrate;
...
@Component("zdsintegrate")
public class ZdsIntegrateImpl extends BaseBl implements ZdsIntegrate {

	@Override
	@InterfaceDocAnnotation(methodVersion = "1.4.0")
	public String zdslogin(RequestContext context) throws BlAppException, DaoAppException {
		CodeTable ct = null;
		try {
			...
			ZdsIntegrateManager ykdIntegrateManager = new ZdsIntegrateManager();
			ykdIntegrateManager.init(context);
			return ykdIntegrateManager.zdsLogin(frontUserEntity);
