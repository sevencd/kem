...
INSERT INTO  `sys_resource`( 
	...
	(205,'/manuscript/preview',now(),now(),1,'manuscript','preview',0,1,''),
	(206,'/paymentservice/searchpaystatus',now(),now(),1,'paymentservice','searchpaystatus',0,1,''),
	(207,'/statistic/collectmanuscriptdata',now(),now(),1,'statistic','collectmanuscriptdata',0,1,''),
	(208,'/manuscript/loadpublishstate',now(),now(),1,'manuscript','loadpublishstate',0,1,'')
	;
